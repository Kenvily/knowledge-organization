...
void LCD_Show_Theme()
{
	...
	LCD_ShowString(60, 30, 200, 16, 16, "Recording Room");
	POINT_COLOR = BLACK;
	LCD_ShowChar(79, 60, '/', 16, 0);
	LCD_ShowChar(102, 60, '/', 16, 0);
	LCD_ShowChar(152, 60, ':', 16, 0);
	LCD_ShowChar(177, 60, ':', 16, 0);

	LCD_ShowString(30+50, 120, 200, 16, 16, "Temp:     C");
	LCD_ShowString(30+50, 140, 200, 16, 16, "Humi:     %");
	LCD_ShowString(30+50, 160, 200, 16, 16, "EX:       %");
	LCD_ShowString(30+50, 180, 200, 16, 16, "ET:       %");
	LCD_ShowString(30+50, 200, 200, 16, 16, "DB:      dB");

    POINT_COLOR = RED;
    LCD_ShowString(30+15, 280, 200, 16, 16, "CRC Error Times:");
    POINT_COLOR = BLACK;
}
